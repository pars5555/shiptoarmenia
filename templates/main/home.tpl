	...
	<div class="sta-for">
		<div class="container">
			<div class="container-fluid text-center">
				...
				<p>Use our expertise to design effective landing pages. After we design and make </p>
				<p>your page, we help you optimize and test it in order to make it even better.</p>
			</div>
		</div>
		<div class="container sta-for-ct">
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
				<div class="top-img">
					<img src="{$SITE_PATH}/img/specialist_image_2.jpg" />
				</div>
		...
		<div class="background-img">
			<div class="container text-center sta-bottom-info-ct">
				...
				<div class="bottom-img">
					<img id="staBottomInfoImg"  alt="A/B test (spilt test)" src="{$SITE_PATH}/img/signicat-ipad-ab1.png">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container text-center">
			...
			<div class="container-fluid">
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<a href="#">
						<img src="{$SITE_PATH}/img/danske-bank.png" />
					</a>
				</div>
				<div class="col-md-3">
					<a href="#">
